        ...
        child: Column(
          ...
          children: [
            ...
            RaisedButton(
              onPressed: () {
                ...
                _passwordTextEditingController.text.isNotEmpty
                  ...
                  builder: (c)
                    {
                      return ErrorAlertDialog(message: "Please write eamil and password",);
                    }
                );
              },
            ...
            FlatButton.icon(
              ...
              icon: (Icon(Icons.admin_panel_settings_rounded, color: Colors.lightGreenAccent,)),
              label: Text("Admin Panel", style: TextStyle(color: Colors.pink, fontWeight: FontWeight.bold),),
            ),
          ],
        ),
      ),
  ...
  void loginUser() async
  {
    ...
    await _auth.signInWithEmailAndPassword(
      ...
      showDialog(
          ...
          builder: (c)
          {
            return ErrorAlertDialog(message: error.message.message.toString(),);
          }
      );
    });
